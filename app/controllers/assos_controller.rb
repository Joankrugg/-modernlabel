class AssosController < ApplicationController
  ...
  def asso_params
    params.require(:asso).permit(:name, :city, :photo, :photo_cache, :address, :activity_class, :description, :county_id, :activity_id, :facebook_page, :user_id, :genre_id, :year_of_creation, :number_of_musicians_max, :phone_number)
  end
end
